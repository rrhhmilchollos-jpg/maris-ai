...
export function GenerationStudio({ jobId, job, phaseLabel, PhaseIcon, appId }: GenerationStudioProps) {
  ...
  const AGENTS = [
    ...
    { id: 'frontend', name: 'Frontend', icon: Code2, color: 'text-emerald-400', phase: 'frontend' },
    { id: 'backend', name: 'Backend', icon: Server, color: 'text-indigo-400', phase: 'backend' },
    { id: 'api', name: 'API', icon: Zap, color: 'text-yellow-400', phase: 'integrations' },
    { id: 'qa', name: 'QA', icon: CheckCircle2, color: 'text-cyan-400', phase: 'testing' },
    { id: 'devops', name: 'DevOps', icon: Rocket, color: 'text-rose-400', phase: 'patching' },
  ];
