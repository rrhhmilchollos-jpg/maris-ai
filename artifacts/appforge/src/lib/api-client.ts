...
export function useCreateCheckoutSession(opts?: { mutation?: Partial<UseMutationOptions<any, any, any>> }) {
  return useMutation<any, any, any>({ mutationFn: ({ data }: any) => apiFetch("/api/billing/checkout", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) }), ...(opts?.mutation as any) });
}
