...
function VeyaNativeClientPage() {
  ...
  useEffect(() => {
    ...
    const clearAutofill = () => {
      setDni("");
      setPassword("");
      document.querySelectorAll<HTMLInputElement>('input[data-veya-client-login="true"]').forEach((input) => {
        input.value = "";
      });
    };
    clearAutofill();
