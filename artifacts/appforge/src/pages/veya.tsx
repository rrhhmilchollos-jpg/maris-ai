        ...
        : marketSection === "devices"
          ...
          : marketSection === "cards"
            ? selectedMarketplaceItem.code === "credit-card"
              ? { requested_limit: marketData.requested_limit, monthly_income: marketData.monthly_income, employment_status: marketData.card_employment_status, request_source: "veya_card_catalog" }
              : selectedMarketplaceItem.code === "virtual-card"
                ? { request_source: "veya_card_catalog", requested_card: "virtual" }
                : { delivery_address: marketData.delivery_address, request_source: "veya_card_catalog", requested_card: "debit_physical" }
