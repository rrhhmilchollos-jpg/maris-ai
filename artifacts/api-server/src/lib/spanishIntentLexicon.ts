...
const DOMAIN_TERMS: Record<SpanishDomain, string[]> = {
  ...
  crm: ["crm", "lead", "leads", "pipeline", "comercial", "comerciales", "crm de ventas", "base de clientes", "lista de leads"],
  user: ["usuario de la app", "usuarios registrados", "trabajador", "trabajadores", "empleado", "empleados", "miembro", "miembros", "cuenta de usuario", "dar de alta usuario", "nuevo usuario en sistema"],
