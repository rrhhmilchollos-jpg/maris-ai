## Kit de Contenido para Directorios de IA

### 1. URL Principal
`https://marisai.es`

### 2. Descripción Corta (150 caracteres)
Maris AI genera apps web y móviles completas con un pipeline de 9 agentes IA especializados. De la idea al código en minutos.

### 3. Descripción Larga (300-500 palabras)
Maris AI es una plataforma innovadora que permite generar aplicaciones web y móviles completas utilizando un avanzado pipeline de 9 agentes de IA especializados. Desde la concepción de la idea hasta el código desplegado, Maris AI transforma el proceso de desarrollo, entregando aplicaciones React full-stack listas para producción en cuestión de minutos.
...
Se necesitan 2-3 capturas de pantalla de alta calidad de la plataforma en funcionamiento.
...
*   **Toolify.ai:** `toolify.ai/submit`
*   **FutureTools.io:** `futuretools.io/submit-a-tool`
*   **AI Tools Directory:** `aitoolsdirectory.com/submit`
*   **Hilo mensual gratuito de TAAFT en X:** Seguir @theresanaiforthat para estar pendiente de los envíos gratuitos.
