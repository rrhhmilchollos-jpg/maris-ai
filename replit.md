...
Each agent has a hard timeout (research 7s, architect 60s, integrations 8s, designer 45s, frontend 180s, backend 90s, QA 8s, tests 30s, patcher 60s) so a hung provider can never leave a job stuck. The validator is local and typically runs in <1s per iteration.
